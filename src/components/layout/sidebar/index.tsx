...
import { Accordion, ActionIcon, Select, Tooltip, Divider } from "@mantine/core";
import {
    GiGearStickPattern,
...
const Sidebar: FunctionComponent = () => {
    ...
    return (
        <aside className="text-[14px] text-slate-900 fixed z-20 left-0 top-0 bg-white h-screen w-48 flex flex-col border-r select-none overflow-auto">
            <div className="px-4 mt-2 mb-2">
                <img
                    src="logo/md.png"
                    alt="Node Crafter logo"
            ...
            >
                <Accordion.Item value="dice">
                    <Accordion.Control
                        icon={<GiPerspectiveDiceOne className="text-[22px]" />}
                    >
                        {t("common.dice")}
                    </Accordion.Control>
                ...
                <Accordion.Item value="symbolic">
                    ...
                    <Accordion.Panel className="bg-white">
                        <ul className="flex flex-col">
                            <SidebarItem
                                nodeType="symbolicGenerator"
                                fullName
                            />
                            <SidebarItem
                                nodeType="bagPullWithoutRepetition"
                                fullName
                            />
                        </ul>
                    </Accordion.Panel>
                ...
                <Accordion.Item value="operations">
                    <Accordion.Control
                        icon={<BiMath className="text-[22px]" />}
                    >
                        {t("common.operations")}
                    </Accordion.Control>
                ...
                <Accordion.Item value="logical">
                    <Accordion.Control
                        icon={<GiGearStickPattern className="text-[22px]" />}
                    >
                        {t("common.logical")}
                    </Accordion.Control>
                ...
                <Accordion.Item value="pools">
                    <Accordion.Control
                        icon={<GiSwapBag className="text-[22px]" />}
                    >
                        {t("common.pools")}
                    </Accordion.Control>
                    ...
                    <Accordion.Panel className="bg-white">
                        <ul className="flex flex-col">
                            ...
                            <SidebarItem
                                nodeType="symbolicGeneratorPool"
                                fullName
                            />
                            <Divider my="xs" />
                            ...
                            <SidebarItem
                                nodeType="symbolicConditionsCheck"
                                fullName={false}
                            />
                ...
                <Accordion.Item value="filters">
                    <Accordion.Control
                        icon={<IoFilterSharp className="text-[22px]" />}
                    >
                        {t("common.filters")}
                    </Accordion.Control>
                    ...
                    <Accordion.Panel className="bg-white">
                        <ul className="flex flex-col">
                            ...
                            <SidebarItem
                                nodeType="selectHighestDice"
                                fullName
                            />
                            <SidebarItem
                                nodeType="selectRandomSymbol"
                                fullName
                            />
                        </ul>
                    </Accordion.Panel>
                ...
                <Accordion.Item value="output">
                    <Accordion.Control
                        icon={<IoBarChartSharp className="text-[22px]" />}
                    >
                        {t("common.output")}
                    </Accordion.Control>
